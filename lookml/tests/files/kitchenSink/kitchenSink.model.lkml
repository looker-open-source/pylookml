...
label: "1) eCommerce with Event Data"include: "*.view"
...
view: order_items {
  ...
  measure: total_sale_price_total {
    type: sum
    value_format_name: usd
    sql: ${sale_price} ;;
    drill_fields: [detail*] 
  }
  measure: total_gross_margin_total {
    type: sum
    value_format_name: usd
    sql: ${gross_margin} ;;
    drill_fields: [detail*] 
  ...
  measure: returned_total_sale_price_total {
    type: sum
    value_format_name: usd
    sql: ${sale_price} ;; 
  }
